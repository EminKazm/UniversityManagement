...
class Librarian(Staff):
    """It has inheritance relationships with Staff and composition with Salary class and
        also composition relantionships with Library class
            It has is_salary attribute and receive_salary,total_salary methods"""
    def __init__(self, librarian_id, name, age, pay, bonus):
        super().__init__(name, age)
        self.librarian_id = librarian_id
        self.salary = Salary(pay, bonus)

    def set_id(self, librarian_id):
        self.librarian_id = librarian_id
    ...
    def receive_salary(self, is_salary):
        if is_salary == True:
            print("Librarian recieves salary")
        else:
            print("Librarian hasnt receive salary yet.")
